...
/* (<any>Chart).elements.Rectangle.prototype.draw = function() {
...
/* 
  export function chartOptions() {
    // Initialize options object with the desired structure
    var options = {
      scales: {  // Add scales property here
        y: [{
          grid: {
            borderColor: (mode == 'dark') ? colors.gray[900] : colors.gray[300],
            borderDash: [2],
            borderDashOffset: [2],
